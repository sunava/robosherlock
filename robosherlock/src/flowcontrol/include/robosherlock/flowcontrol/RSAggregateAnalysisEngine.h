...
public:
  ...
  */
  ...
  /**
   * @brief overwriteParam specific case for strings because of uima working with icu::UnicodeStrings
   * @param ae_ame
   * @param param_name
   * @param param
   */
...
//RSAggregateAnalysisEngine *createParallelAnalysisEngine(icu::icu::UnicodeString const &aeFile,
